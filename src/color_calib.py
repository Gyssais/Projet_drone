...
class ColorCalib:
    ...
    def create(self):
        ...
        cv2.createTrackbar(H_NAME, WINDOW_NAME, MIN_TOLERANCE, MAX_TOLERANCE, self._on_change_h)
        cv2.createTrackbar(S_NAME, WINDOW_NAME, MIN_TOLERANCE, MAX_TOLERANCE, self._on_change_s)
        cv2.createTrackbar(V_NAME, WINDOW_NAME, MIN_TOLERANCE, MAX_TOLERANCE, self._on_change_v)
